...
class CustomerService:
    ...
    def create_customer(self, name: str, email: str, phone: Optional[str] = None, city: Optional[str] = None, address: Optional[str] = None) -> Dict:
        try:
            return self.dao.create_customer(name, email, phone, city, address)
    ...
    def update_customer(self, cust_id: int, phone: Optional[str] = None, city: Optional[str] = None, address: Optional[str] = None) -> Optional[Dict]:
        fields = {}
        ...
        if not fields:
            raise CustomerServiceError("At least one field must be provided for update")
        try:
